"Let's try studyng Control LA versus Control HA"
...
targets <- read_tsv("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/studydesign_group2.tsv")# read in your study design
...
"Probably next time?"
capture.output(myTPM, file = "C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/myTPM.csv")
...
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure1_Scatterplot_TPM_stats",  width = 4, height = 4, device='tiff', dpi=500)
...
ggplot(myTPM.stats) + 
  ...
  theme_dark() + 
  theme_bw()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure2_Scatterplot_TPM_stats_Line",  width = 4, height = 4, device='tiff', dpi=500)
...
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure3_Violin_Plot_Unfiltered_Non_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
pq1 <- ggplot(Alternate_df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure3_BlindedViolin_Plot_Unfiltered_Non_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
pq2 <- ggplot(Alternate1.cpm.filtered.df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure4_BlindedViolin_Plot_filtered_Non_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
pq3 <- ggplot(Alternate2_df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure5_BlindedViolin_Plot_filtered_TMM_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
#948 genes were absent, and have no counts
#34500 genes have some data
...
p2 <- ggplot(log2.cpm.filtered.df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure4_Violin_Plot_filtered_Non_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
p3 <- ggplot(log2.cpm.filtered.norm.df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure5_Violin_Plot_filtered_TMM_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure7_PCA_plot_HA_vs_LA_42",  width = 10, height = 4, device='tiff', dpi=500)
ggplotly(pca.plot)
...
ggplot(pca.pivot) +
  ...
  theme_bw() +
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure9Blinded_PCA_Small_multiple_plots",  width = 10, height = 4, device='tiff', dpi=500)
...
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure10_HighaltiudevsLowaltitude_plot",  width = 10, height = 4, device='tiff', dpi=500)
...
vplot <- ggplot(myTopHits.df) +
  ...
  labs(title="Volcano plot",
       ...
       caption=paste0("produced on ", Sys.time())) +
  theme_bw()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/Figure11_Volcano_plot_LogversusLogFC_21_April",  width = 10, height = 4, device='tiff', dpi=500)
...
write_tsv(diffGenes.df,"C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_control_vs_HA_control(8_7)/DiffGenes_2.txt") #NOTE: this .txt file can be directly used for input into other clustering or network analysis tools (e.g., String, Clust (https://github.com/BaselAbujamous/clust, etc.)
