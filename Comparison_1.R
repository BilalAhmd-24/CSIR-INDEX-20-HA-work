...
targets <- read_tsv("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/studydesign_group1.tsv")# read in your study design
...
"Probably next time?"
capture.output(myTPM, file = "C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/myTPM.csv")
...
#ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure1_Scatterplot_TPM_stats",  width = 4, height = 4, device='tiff', dpi=500)
...
ggplot(myTPM.stats) + 
  ...
  theme_dark() + 
  theme_bw()
#ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure2_Scatterplot_TPM_stats_Line",  width = 4, height = 4, device='tiff', dpi=500)


"Crucial step: Now, lets deal with DGE data"

"#1Figure out, Why we are using counts here again?"
...
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure3_Violin_Plot_Unfiltered_Non_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
new_sampleLabels <-  c( "Sample-1", "Sample-2", "Sample-3", "Sample-4", "Sample-5",
                          "Sample-6", "Sample-7", "Sample-8", "Sample-9", "Sample-10", "Sample-11", "Sample-12", "Sample-13", "Sample-14", "Sample-15", "Sample-16","Sample-17", "Sample-18", "Sample-19", "Sample-20", "Sample-21", "Sample-22", "Sample-23", "Sample-24", "Sample-25", "Sample-26", "Sample-27", "Sample-28", "Sample-29", "Sample-30")
...
pq1 <- ggplot(Alternate_df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure3_BlindedViolin_Plot_Unfiltered_Non_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
pq2 <- ggplot(Alternate1.cpm.filtered.df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure4_BlindedViolin_Plot_filtered_Non_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
pq3 <- ggplot(Alternate2_df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure5_BlindedViolin_Plot_filtered_TMM_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
#850 genes were absent, and have no counts
#34598 genes have some data
...
#Focus on this, it was 10 first
keepers <- rowSums(cpm>1)>=15 #user defined
...
p2 <- ggplot(log2.cpm.filtered.df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure4_Violin_Plot_filtered_Non_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
p3 <- ggplot(log2.cpm.filtered.norm.df.pivot) +
  ...
  theme_bw()+
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure5_Violin_Plot_filtered_TMM_Normalized",  width = 10, height = 4, device='tiff', dpi=500)
...
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure7_PCA_plot_HA_vs_LA_42",  width = 10, height = 4, device='tiff', dpi=500)
ggplotly(pca.plot)
...
ggplot(pca.pivot) +
  ...
  theme_bw() +
  coord_flip()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure9Blinded_PCA_Small_multiple_plots",  width = 10, height = 4, device='tiff', dpi=500)
...
colnames(mydata.df) <- c('GeneID', 'La1','La2','La3','La4','La5','La6','La7','La8','La9','La10','La11','La12','La13','La14','La15','La16',
                         'Ha1','Ha2','Ha3','Ha4','Ha5','Ha6','Ha7','Ha8','Ha9','Ha10','Ha11','Ha12','Ha13','Ha14')
view(mydata.df)

#Calculating the average gene expression data
mydata.df <- mydata.df %>% 
  mutate(Low_altitude.AVG = (La1+ La2 + La3 + La4 + La5 + La6 + La7 + La8 + La9 + La10 + La11 + La12 + La13 + La14 + La15 + La16)/16,
         High_altitude.AVG =(Ha1+ Ha2 + Ha3 + Ha4 + Ha5 + Ha6 + Ha7 + Ha8 + Ha9 + Ha10 + Ha11 + Ha12 + Ha13 + Ha14)/14,
...
mydata.grep <- mydata.df %>%
  dplyr::filter(grepl('EPAS1|EGLN1', GeneID)) %>%
...
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure10_HighaltiudevsLowaltitude_plot",  width = 10, height = 4, device='tiff', dpi=500)
...
vplot <- ggplot(myTopHits.df) +
  ...
  labs(title="Volcano plot",
       ...
       caption=paste0("produced on ", Sys.time())) +
  theme_bw()
ggsave("C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/Figure11_Volcano_plot_LogversusLogFC",  width = 10, height = 4, device='tiff', dpi=500)
...
write_tsv(diffGenes.df,"C:/Users/mohin/Desktop/Medgenome_data/Analysis_Bilal/Comparisons/LA_vs_HA_samples(16_14)/DiffGenes_20.txt") #NOTE: this .txt file can be directly used for input into other clustering or network analysis tools (e.g., String, Clust (https://github.com/BaselAbujamous/clust, etc.)
